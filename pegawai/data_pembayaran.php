                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    while ($data_pembayaran = $result->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($data_pembayaran['222247_status_pembayaran']); ?></td>
                                            <td><?php echo htmlspecialchars($data_pembayaran['222247_tanggal_pembayaran']); ?></td>
                                            <td><?php echo htmlspecialchars($data_pembayaran['222247_total_harga']); ?></td>
                                            <td>
                                ...
                                <tfoot>
                                    <tr>
                                        <th>No</th>
                                        <th>Tanggal Pesanan</th> <!-- Kolom untuk Tanggal Pesanan -->
                                        <th>Status Pembayaran</th>
                                        <th>Tanggal Pembayaran</th>
                                        <th>Total Harga</th>
                                        <th>Aksi</th>
